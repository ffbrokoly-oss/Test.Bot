...
API_ID = int(environ['36587128'])
API_HASH = environ['e5ec610ce3a01705e20b57823159ad4d']
BOT_TOKEN = environ['8686136792:AAGvDV1UX0C6XOX0ugAm4yRTOVmRRYZBsjo']
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003688587446 -1003885349559').split()]
...
# MongoDB information *
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://shawrahul887789_db_user:shawrahul887789_db_user@cluster0.cmlbq92.mongodb.net/?appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# LOG CHANNELS *
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1003688587446 -1003885349559))
